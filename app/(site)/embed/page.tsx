    ...
    <main className="mx-auto max-w-3xl px-5 py-10 sm:py-16">
      <header className="mb-10">
        ...
        <p className="mt-3 text-lg text-patina-800/80">
          One iframe. Free forever. Your readers see their true Etsy profit
      ...
      <section className="space-y-4 text-patina-800/85">
        ...
        <p>
          If you write about Etsy pricing, run a print-on-demand supplier site,
          teach a seller course, or maintain an affiliate review post, the
          calculator turns a passive page into an interactive one. Readers stick
          around. Bounce rate drops. You don&apos;t have to maintain any code.
        </p>
      </section>
      ...
      <section className="mt-10">
        ...
        <p className="mt-2 text-patina-800/85">
          Drop this anywhere HTML is allowed (WordPress custom HTML block,
          Webflow embed, Ghost HTML card, plain Markdown with HTML support, etc.).
        </p>
        <div className="mt-4">
      ...
      <section className="mt-12 space-y-4 text-patina-800/85">
        ...
        <p>
          Pre-load the calculator with your reader&apos;s scenario by appending
          query params to the iframe&apos;s <code className="rounded bg-cream-100 px-1.5 py-0.5 text-sm text-patina-900">src</code>:
        </p>
        <ul className="space-y-2 rounded-2xl bg-white p-5 ring-1 ring-patina-100 text-sm">
          <li>
            <code className="text-patina-900">p</code> — item sale price (e.g. <code className="text-patina-900">p=24</code>)
          </li>
          <li>
          ...
          <li>
            <code className="text-patina-900">c</code> — country code: <code>US</code>, <code>UK</code>, <code>CA</code>, <code>AU</code>, <code>EU</code>
          </li>
          <li>
            <code className="text-patina-900">ads</code> — Off-Site Ads on (<code>1</code>) or off (<code>0</code>)
          </li>
          <li>
            <code className="text-patina-900">t10</code> — at/over $10k revenue (<code>1</code>) or under (<code>0</code>)
          </li>
        </ul>
        <p>
...
{`https://etsymargin.tools/embed/widget?p=24&s=5.5&m=11&as=5.5&ads=1`}
      ...
      <section className="mt-12 space-y-3 text-sm text-patina-800/80">
        ...
        <p>
          Free to embed on any site, commercial or otherwise. We just ask that
          the small &quot;Powered by etsymargin.tools&quot; link below the
          calculator stays in place — that&apos;s how new sellers find us.
        </p>
        <p>
          The widget is fully client-side. No third-party tracking scripts run
          inside the iframe — your readers&apos; data never touches our servers.
        </p>
      </section>
    </main>
  );
