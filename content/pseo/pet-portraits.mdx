...
## What pet portraits actually sell for on Etsy — and what each nets

The category spans a wide price ladder, and the fee profile changes completely as you climb it:

- **Digital download ($10–35).** No materials, no shipping — the ~90% margin above. A $25 digital portrait nets around $22 after fees. Highest-margin rung, and it needs no fulfillment partner.
- **Printed & shipped ($40–70).** Now there's a physical product: a print, sometimes a frame, and postage. A $60 framed portrait fulfilled through a POD partner might cost $18 in product plus $8 shipping, so you keep far less per dollar — but order value roughly doubles at almost no added illustration time.
- **Hand-painted commission ($100–500+).** Priced on hours, not materials; the $100 Off-Site Ads cap starts working in your favor above ~$667.

The digital-vs-printed fork is the real decision. The digital file is your hero — highest margin, zero fulfillment. A printed or framed upsell trades roughly 40 margin points for about 2× order value at near-zero extra labor, so treat it as an add-on for buyers who want a physical keepsake, not a replacement. If you do offer the printed tier, a print-on-demand partner like Printify handles the product and postage so you never touch inventory.
