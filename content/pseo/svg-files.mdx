...
## Selling the same cut files off Etsy (your own store)

An SVG has no cost of goods — so Etsy's fee stack _is_ your entire expense: a ~21% floor on a $4 file, ~36% once Off-Site Ads attribute the sale. That's the same self-driven Pinterest and TikTok traffic from the section above, taxed on the way through Etsy's checkout. The identical file sold from your own storefront keeps roughly 95% — no listing fee, no 6.5% transaction fee, no Off-Site Ads, just card processing around 2.9% + $0.30.

The honest tradeoff is traffic, not fees: Etsy sends you buyers; your own store doesn't. So the move isn't "leave Etsy" — it's Etsy for discovery, your own store (a fee-free storefront like Sellfy) for the loyal buyers you already drive from social. A storefront on a flat monthly plan pays for itself once the retained 21–36% clears the subscription — for most bundle-led shops, only a few dozen sales a month.
