...
## Three ways to sell journals on Etsy — and the margin each delivers

Most people searching how to sell journals on Etsy haven't committed to a binding table yet — and the route decides the economics far more than the design does:

- **Hand-bound (the page above).** Highest margin percentage — a genuinely handmade leather journal holds $48–88 — but your ceiling is your own hands. At 60–90 minutes a journal, this is a premium, low-volume craft business, not a scale play.
- **Print-on-demand.** A POD hardcover, softcover, or spiral notebook runs roughly $6–12 with zero labor and no inventory; you design the cover and interior, the partner prints and ships. Lower margin per unit, but it scales past what you could ever bind by hand. Providers like Gelato fulfill notebooks and journals on demand.
- **Printable / digital.** A PDF or GoodNotes journal has ~$0 cost of goods and 90%+ margin — the highest-margin route of the three, capped only by traffic (mostly Pinterest and TikTok).

There's no single right answer: hand-binding wins the margin percentage and the craft positioning, POD wins the volume, printable wins the margin dollars per hour of your time. Match the route to whether you're selling a hand-made object or a design.
