...
export const mdxComponents: MDXComponents = {
  h2: (props) => (
    <h2 className="mt-10 mb-4 text-2xl font-bold text-patina-900 sm:text-3xl" {...props} />
  ),
  h3: (props) => <h3 className="mt-8 mb-3 text-xl font-semibold text-patina-900" {...props} />,
  p: (props) => <p className="my-4 text-base leading-relaxed text-patina-800/85" {...props} />,
  ul: (props) => <ul className="my-4 list-disc space-y-2 pl-6 text-patina-800/85" {...props} />,
  ol: (props) => <ol className="my-4 list-decimal space-y-2 pl-6 text-patina-800/85" {...props} />,
